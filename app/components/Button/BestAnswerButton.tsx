...
export const BestAnswerButton = ({ answerId, bestInfo, questionId, isBest, onBest }: BestAnswerButtonProps) => {
    ...
    const handleBestAnswer = async () => {
        ...
        try {
            let response;
            if (isBest === false) {
                response = await fetch(`/api/questions/${String(questionId)}/best-answer`,
                    {
                        method: 'PATCH',
                        headers: {
